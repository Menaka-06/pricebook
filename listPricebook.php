                                            ...
                                            <tr>
                                                ...
                                                <?php if($this->rbac->display_operation('materialcategory','editMaterialCategory')){?>
                                                    <a href="<?php echo base_url();?>pricebook/editPricebookList/<?php echo $this->common_model->encode($PB->id);?>">
                                                        <i class="ri-edit-2-fill icons edit mx-2" title="Edit"></i></a>
                                                 <?php } ?>
                                                      

                                                 <?php if($this->rbac->display_operation('materialcategory','deleteMaterialCategory')){?>
                                                       <a href="javascript:void(0);" data-url="<?php echo base_url();?>pricebook/deletePricebook/<?php echo $this->common_model->encode($PB->id);?>" class="sa-warning"><i class=" ri-delete-bin-fill icons delete" title="Delete"></i></a>
                                                 <?php } ?>
